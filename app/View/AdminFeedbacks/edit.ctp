...
<?
    ...
    $tabs = array(
        __('General') => $this->Html->div('form-body',
            $this->PHForm->input('name', array('label' => array('class' => 'col-md-3 control-label', 'text' => 'Имя студента')))
            .$this->PHForm->input('title', array('label' => array('class' => 'col-md-3 control-label', 'text' => 'Род занятий')))
